            ...
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                           <table id="Dt_detallemiscursos" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Curso</th>
...
<script>
    ...
    var detallecurso = function(){
           var table =$("#Dt_detallemiscursos").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoMisCursos.php?id_user="+<?php echo $user;?>,
           ...
           descargar_archivo("#Dt_detallemiscursos tbody",table);
    }
    var descargar_archivo = function(tbody,table) {
        $(tbody).on("click","button.descargar",function() {
            ...
            var fecha_finalizacion = data.fecha_finalizacion;
            if (fecha_finalizacion != "0000-00-00 00:00:00"){
                window.location.href="certificado.php?id_curso="+id_curso+"&id_user="+id_user;
            }else{
                alert("El Curso no se encuentra finalizado");
            }
        });
    }
    var idioma_espanol = {
