        ...
        var detalleevaluacion = function(){
            ...
            var table =$("#Dt_detalleevaluacion").DataTable({
                ...
                "columns":[
                    ...
                    {"data":"estado"},                    
                    {"defaultContent":"<button type='button'  class='preguntas btn btn-xs btn-info' onclick='ingresar_preguntas();' title='Preguntas'><span class='glyphicon glyphicon-inbox'></span></button><button type='button'  class='visualizar btn btn-xs btn-success' onclick='visualiza_evaluacion();' title='Evaluación'><span class='glyphicon glyphicon-print'></span></button><button type='button'  class='activar btn btn-xs btn-primary' onclick='activar_evaluacion();' title='Activar'><span class='glyphicon glyphicon-check'></span></button><button type='button'  class='eliminar btn btn-xs btn-danger' onclick='eliminar_evaluacion();' title='Inactivar'><span class='glyphicon glyphicon-remove'></span></button>"}
                ],
