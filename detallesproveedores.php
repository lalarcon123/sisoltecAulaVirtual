        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_proveedor.php");
                    include("modal/new_proveedor.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Proveedores</h2>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detalleproveedores").DataTable({
               ...
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoProveedores.php",
        ...
        obtener_data_editar("#Dt_detalleproveedores tbody",table);
    }
    ...
    $(tbody).on("click", "button.editar", function () {
        ...
        var id                     = $("#id").val(data.id),
            ...
            telefono_representante = $("#telefono_representante").val(data.telefono_representante),
            sitioweb               = $("#sitioweb").val(data.sitioweb),
