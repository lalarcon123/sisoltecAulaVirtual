<?php
  ...
  $page_title = 'Listado Evaluación Estudiante';
  require_once('includes/load.php');

  $user = $_SESSION['user_id'];
  $listado_cursos  =find_all_curso_est('estudiante_curso', $user);
  $nombre_curso = "";
  if (!empty($id_curso)){
...
if(isset($_POST['consultar'])) {
        ...
        $id_evaluacion  = remove_junk($db->escape($_POST['id_evaluacion']));
        redirect('ConsultaListadoEvaluacionEstudiante.php?id_curso='.$id_curso.'&id_evaluacion='.$id_evaluacion, false);
}
    ...
    <script language="JavaScript">
        $(document).ready(function () {
           $("#id_curso").change(function () {
              $("#id_curso option:selected").each(function () {
                 id_curso = $(this).val();
                 $.post("includes/getEvaluaciones.php",{id_curso :id_curso}, function (data) {
                     $("#id_evaluacion").html(data);
                  });
              });
           })
        });
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="ConsultaListadoEvaluacionEstudiante.php?id_curso=<?php echo $id_curso ?>&id_evaluacion=<?php echo $id_evaluacion ?>" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  <div class="col-md-5">
                                      <div class="form-group">
                                          <label for="qty">Evaluación*</label>
                                          <div class="input-group">
                                                <span class="input-group-addon">
                                                   <i class="glyphicon glyphicon-th-large"></i>
                                                </span>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
    ...
    <script>
        ...
        var detallerestudiante = function(){
            ...
            var id        = <?php echo $id_evaluacion?>;
            var id_user   = <?php echo $user?>;
            var table =$("#Dt_detalleestudiante").DataTable({
                "destroy":true,
                "ajax":{
                    "method":"POST",
                    "url":"ajax/ListadoEvaluacionesEst.php?id_curso="+id_curso+"&id="+id+"&id_user="+id_user,
                ...
                buttons: [
                     ...
                     extend:    'pdfHtml5',
                     titleAttr: 'pdf',
                     title: 'Listado Evaluación Estudiante',
                     exportOptions:{
                         columns: [0,1,2,3]
                       }
                     }
