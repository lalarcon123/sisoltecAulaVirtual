<?php
  ...
  $page_title = 'Listado Actividades Estudiantes';
...
if(isset($_POST['consultar'])) {
        ...
        redirect('ConsultaListadoActividadesxEstudiantes.php?id_curso='.$id_curso, false);
}
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="ConsultaListadoActividadesxEstudiantes.php?id_curso=<?php echo $id_curso ?>" enctype="multipart/form-data">
    ...
    <script>
        ...
        var detallerestudiante = function(){
            ...
            var table =$("#Dt_detalleestudiante").DataTable({
                ...
                "ajax":{
                    "method":"POST",
                    "url":"ajax/ListadoActividadesEstudiante.php?id_curso="+id_curso+"&id_user="+id_user,
                ...
                buttons: [
                     ...
                     extend:    'pdfHtml5',
                     titleAttr: 'pdf',
                     title: 'Listado Actividades Estudiante',
                     exportOptions:{
                         columns: [0,1,2,3,4]
                       }
                     }
