<?php
  ...
  $page_title = 'Listado Evaluación Estudiantes';
...
if(isset($_POST['consultar'])) {
        ...
        redirect('ConsultaListadoEvaluacioEstudiantes.php?id_curso='.$id_curso.'&id_evaluacion='.$id_evaluacion, false);
}
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="ConsultaListadoEvaluacioEstudiantes.php?id_curso=<?php echo $id_curso ?>&id_evaluacion=<?php echo $id_evaluacion ?>" enctype="multipart/form-data">
    ...
    <script>
        ...
        var detallerestudiante = function(){
            ...
            var table =$("#Dt_detalleestudiante").DataTable({
                ...
                "ajax":{
                    "method":"POST",
                    "url":"ajax/ListadoEvaluaciones.php?id_curso="+id_curso+"&id="+id,
                ...
                buttons: [
                     ...
                     extend:    'pdfHtml5',
                     titleAttr: 'pdf',
                     title: 'Listado Evaluación Estudiantes',
                     exportOptions:{
                         columns: [0,1,2,3]
                       }
                     }
