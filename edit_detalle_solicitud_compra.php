...
if(isset($_POST['regresar'])) {
        redirect('detallessolicitudescompra.php', false);
}
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_detalle_solicitud_compra.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>&id_proveedor=<?php echo $id_proveedor ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon"><i class="glyphicon glyphicon-th-large"></i></span>
                                        <select class="form-control" name="id_producto" id="id_producto">
                                          ...
                                          <?php foreach ($all_prod_x_prov as $producto_proveedores ):?>
                                           <option value="<?php echo $producto_proveedores['id_producto'];?>"><?php echo ucwords($producto_proveedores['nombre_producto']);?></option>
                                        <?php endforeach;?>
                                        </select>
                                    </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <span class="input-group-addon"><i class="glyphicon glyphicon-th-large"></i></span>
                                        <input type="text" class="form-control" name="cantidad"  id="cantidad" placeholder="Cantidad" onkeyup="this.value=Num(this.value)" maxlength="10" />
                                    </div>
                              </div>
                            </div>
                           </div>
                            <div><button type="submit" name="add" class="btn btn-primary">Agregar Producto</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-danger">Regresar</button></form></div>
                            <div class="x_content">
    ...
    <script>
        ...
        var activar_detalle = function(tbody,table) {
           $(tbody).on("click","button.activar",function() {
                ...
                var id_solicitud_compra = data.id_solicitud_compra;
                var descripcion         = data.nombre_proveedor;
                window.location.href="activadetallesolcomp.php?id="+id+"&id_solicitud_compra="+id_solicitud_compra+"&descripcion="+descripcion+"&id_proveedor="+id_proveedor;
            });
        }
