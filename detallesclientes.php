        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_clientes.php");
                    include("modal/new_clientes.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Clientes</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detallecliente" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Nombre</th>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detallecliente").DataTable({
               "responsive":true,
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoClientes.php",
        ...
        obtener_data_editar("#Dt_detallecliente tbody",table);
    }
