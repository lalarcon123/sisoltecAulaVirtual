<?php
  ...
  $page_title = 'Informe Estudiantes';
...
if(isset($_POST['consultar'])) {
        ...
        redirect('ConsultaInformeEstudiantes.php?id_curso='.$id_curso.'&id_estudiante='.$id_estudiante, false);
}
          ...
          $(document).ready(function () {
             $("#id_curso").change(function () {
                $("#id_curso option:selected").each(function () {
                   id_curso = $(this).val();
                   $.post("includes/getEstudiantes.php",{id_curso :id_curso}, function (data) {
                       $("#id_estudiante").html(data);
                    });
                });
             })
          });
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                  <strong>
                    ...
                    <?php
                        if ($nombre_curso){
                            $titulo = "<span>Informe Estudiantes del curso $nombre_curso</span>";
                        } else {
                           $titulo = "<span>Informe Estudiantes</span>";   
                        }
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <form method="post" action="ConsultaInformeEstudiantes.php?id_curso=<?php echo $id_curso ?>&id_estudiante=<?php echo $id_estudiante?>" enctype="multipart/form-data">
    ...
    <script>
        ...
        var detallerestudiante = function(){
            ...
            var table =$("#Dt_detalleestudiante").DataTable({
                ...
                "ajax":{
                    "method":"POST",
                    "url":"ajax/ListadoEstudiantesConsolidado.php?id_curso="+id_curso+"&id_user="+id_estudiante,
