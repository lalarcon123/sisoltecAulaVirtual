...
if(isset($_POST['add'])) {
   ...
   if(empty($errors)){
        ...
        $query .="ruc, nombre, descripcion, telefono, correo, direccion, representante ";
        $query .=") VALUES (";
        $query .=" '{$ruc}', '{$nombre}', '{$descripcion}', '{$telefono}', '{$correo}','{$direccion}','{$representante}' ";
        $query .=")";
        if($db->query($query)){
          //sucess
          $session->msg('s',"Empresa ingresada exitosamente. ");
        } else {
          //failed
          echo "<script>alert('No se pudo crear la empresa.');</script>";
        }
   } else {
...
<script>
    ...
    <div> <!-- Modal -->
        ...
        <div class="panel-heading clearfix">
            <div class="pull-left">
                <button type="button" class="btn btn-default" data-toggle="modal" data-target=".bs-example-modal-lg-add"><i class="fa fa-plus-circle"></i> Agregar Empresa <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                </button>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" class="form-control" name="nombre" placeholder="Nombre empresa" maxlength="50" required onKeyUp="this.value=this.value.toUpperCase();" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="email" class="form-control" name="correo" placeholder="Correo" maxlength="50" onKeyUp="this.value=this.value.toUpperCase();" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" class="form-control" name="representante" placeholder="Representante" maxlength="50" required onKeyUp="this.value=this.value.toUpperCase();" />
                            </div>
                        </div>
