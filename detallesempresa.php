        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_empresa.php");
                    include("modal/new_empresa.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Empresas</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detalleempresa" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Nombre</th>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detalleempresa").DataTable({
               "responsive":true,
               "destroy":true,
               "ajax":{
                   "method":"POST",
        ...
        obtener_data_editar("#Dt_detalleempresa tbody",table);
    }
    ...
    $(tbody).on("click", "button.editar", function () {
        ...
        var id            = $("#id").val(data.id),
            ...
            representante = $("#representante").val(data.representante),
