        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_tipo_proyecto.php");
                    include("modal/new_tipo_proyecto.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Tipo Proyecto</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detalletipoproyecto" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Descripción</th>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detalletipoproyecto").DataTable({
               "responsive":true,
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoTipoProyectos.php",
        ...
        obtener_data_editar("#Dt_detalletipoproyecto tbody",table);
    }
