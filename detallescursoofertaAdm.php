...
<script>
    ...
    $(tbody).on("click","button.material",function() {
            ...
            if (estado == 'ACTIVO'){
                window.location.href="edit_duplicar.php?id="+id+"&id_curso="+id_curso+"&id_docente="+id_docente;
            } else {
                alert("El curso se encuentra finalizado");
            }
    });
    }
    var idioma_espanol = {
