        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_subopciones.php");
                    include("modal/new_subopciones.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Opciones</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detallesubopciones" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Menú</th>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detallesubopciones").DataTable({
               "responsive":true,
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoSubOpciones.php",
        ...
        obtener_data_editar("#Dt_detallesubopciones tbody",table);
    }

    var obtener_data_editar = function(tbody,table) {
    $(tbody).on("click", "button.editar", function () {
        var data = table.row($(this).parents("tr")).data();
        var det_menu_id     = $("#det_menu_id").val(data.det_menu_id),
            id_menu         = $("#id_menu").val(data.id_menu),
            descripcion     = $("#descripcion").val(data.descripcion),
            estado          = $("#estado").val(data.estado),
            pagina          = $("#pagina").val(data.pagina),
