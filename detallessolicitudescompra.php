...
<script>
    ...
    $(tbody).on("click","button.detalle",function() {
            ...
            if (estado!='FINALIZADA'){
              window.location.href="edit_detalle_solicitud_compra.php?id="+id+"&id_proveedor="+id_proveedor+"&descripcion="+descripcion;
            }else{
