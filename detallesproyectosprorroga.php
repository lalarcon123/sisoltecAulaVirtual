        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                        include("modal/upd_proyecto_prorroga.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Proyectos Prorroga</h2>
...
<script>
    ...
    var detalleuser = function(){
           ...
           var table =$("#Dt_detalleproyecto").DataTable({
               ...
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoProyectosProrroga.php?id="+id,
    ...
    $(tbody).on("click", "button.editar", function () {
        ...
        var id                 = $("#id").val(data.id),
            fecha_fin_anterior = $("#fecha_fin_anterior").val(data.fecha_fin);
    });
    }

    var proyectoprorroga = function(tbody,table){
    $(tbody).on("click","button.recursos",function() {
            var data       = table.row($(this).parents("tr")).data();
            var id         = data.id;
            var nombre     = data.nombre;
            window.location.href="edit_proyectos_prorroga.php?id="+id+"&nombre="+nombre;
    });
    }    
