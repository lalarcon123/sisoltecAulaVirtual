        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_curso.php");
                    include("modal/new_curso.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Curso</h2>
...
<script>
    ...
    var detallecurso = function(){
        ...
        descargar_archivo("#Dt_detallecurso tbody",table);
    ...
    $(tbody).on("click", "button.editar", function () {
        ...
        var id = $("#id").val(data.id),
            ...
            duracion       = $("#duracion").val(data.duracion),
            puntaje_minimo = $("#puntaje_minimo").val(data.puntaje_minimo),
