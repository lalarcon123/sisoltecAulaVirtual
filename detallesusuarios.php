            ...
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                           <table id="Dt_detalleusuarios" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Nombre</th>
...
<script>
    ...
    var detalleuser = function(){
           var table =$("#Dt_detalleusuarios").DataTable({
               "responsive":true,
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoUsuarios.php",
        ...
        obtener_data_editar("#Dt_detalleusuarios tbody",table);
        cambio_password("#Dt_detalleusuarios tbody",table);
        reseteo_password("#Dt_detalleusuarios tbody",table);
    }
    ...
    var cambio_password = function(tbody,table) {
        $(tbody).on("click", "button.password", function () {
            var data = table.row($(this).parents("tr")).data();
            var id   = data.id;
            window.location.href="edit_user_password.php?id="+id;
        });
    }
