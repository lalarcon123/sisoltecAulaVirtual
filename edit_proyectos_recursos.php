                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" action="edit_proyectos_recursos.php?id=<?php echo $id ?>&descripcion=<?php echo $descripcion ?>" enctype="multipart/form-data">
                            ...
                            <div><button type="submit" name="recursos_proyectos" class="btn btn-primary">Asignar Trabajador</button><form method="post" action="regresar"><button type="submit" name="regresar" class="btn btn-danger">Regresar</button></form></div>
                            <?php
