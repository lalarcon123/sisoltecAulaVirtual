        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_tipomaterial.php");
                    include("modal/new_tipomaterial.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Tipo Material</h2>
                        ...
                        <div class="x_content">
                           <table id="Dt_detalletipomaterial" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Descripción</th>
...
<script>
    ...
    var detalletipomaterial = function(){
           var table =$("#Dt_detalletipomaterial").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoTipoMaterial.php",
               ...
               "columns":[
                   ...
                   {"data":"descripcion"},
                   {"data":"estado"},
                   {"defaultContent":"<button type='button' class='editar btn btn-primary btn-xs' onclick='obtener_data_editar();' data-toggle='modal' data-target='.bs-example-modal-lg-udp'><i class='fa fa-pencil-square-o'></i><span class='glyphicon glyphicon-edit'></span></button>"}
               ],
               "language": idioma_espanol
           });
        obtener_data_editar("#Dt_detalletipomaterial tbody",table);
    }
