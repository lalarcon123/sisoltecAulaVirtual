<?php 
    ...
    $title ="Listado de Registro de cursos";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    //include("modal/upd_registrocurso.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                        ...
                        <div class="x_content">
                           <table id="Dt_detalleregistrocurso" class="table table-bordered table-hover" cellpadding="0" width="100%">
                               <thead>
                                    <tr>
                                        <!--<th>id</th>-->
                                        <th>Descripción</th>
...
<script>
    $(document).on("ready",function(){
        detalleregistrocurso();
    });
    var detalleregistrocurso = function(){
           var table =$("#Dt_detalleregistrocurso").DataTable({
               "destroy":true,
               "ajax":{
                   "method":"POST",
                   "url":"ajax/ListadoRegistrodeCursos.php",
               ...
               "columns":[
                   ...
                   {"data":"fecha_registro"},
                   {"data":"fecha_pago"},
                   {"defaultContent":"<button type='button' class='editar btn btn-success btn-xs' onclick='obtener_data_editar();' data-toggle='modal' data-target='.bs-example-modal-lg-udp'>Pago  <i class='fa fa-pencil-square-o'></i><span class='glyphicon glyphicon-shopping-cart'></span></button>"}
               ],
               "language": idioma_espanol
           });
        obtener_data_editar("#Dt_detalleregistrocurso tbody",table);
    }
    ...
    $(tbody).on("click", "button.editar", function () {
        ...
        var id = $("#id").val(data.id),
            ...
            docente        = $("#docente").val(data.docente),
            estudiante     = $("#estudiante").val(data.estudiante),
            fecha_registro = $("#fecha_registro").val(data.fecha_registro),
            fecha_pago     = $("#fecha_pago").val(data.fecha_pago),
