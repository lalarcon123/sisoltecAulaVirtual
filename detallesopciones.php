        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                    include("modal/upd_opciones.php");
                    include("modal/new_opciones.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Módulos</h2>
...
<script>
    ...
    var detalleuser = function(){
        ...
        obtener_data_editar("#Dt_detalleopciones tbody",table);
    }

    var obtener_data_editar = function(tbody,table) {
    $(tbody).on("click", "button.editar", function () {
        var data = table.row($(this).parents("tr")).data();
        var id_menu         = $("#id_menu").val(data.id_menu),
